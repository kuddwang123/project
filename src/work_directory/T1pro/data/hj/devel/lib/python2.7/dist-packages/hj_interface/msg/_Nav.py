...
class Nav(genpy.Message):
  _md5sum = "0b6175bea0cd7c81196cedf009671df5"
...
# float32 pump_a  # del
# float32 pump_b # del"""
  __slots__ = ['custom_time','left_msg','right_msg']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       custom_time,left_msg,right_msg
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2I2f().pack(_x.custom_time.secs, _x.custom_time.nsecs, _x.left_msg, _x.right_msg))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.custom_time.secs, _x.custom_time.nsecs, _x.left_msg, _x.right_msg,) = _get_struct_2I2f().unpack(str[start:end])
