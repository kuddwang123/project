...
"""autogenerated by genpy from hj_interface/Pose.msg. Do not edit."""
import codecs
import sys
...
class Pose(genpy.Message):
  _md5sum = "309cca155b5af2dd272663421af0073b"
  _type = "hj_interface/Pose"
...
float64 y
float64 z"""
  __slots__ = ['header','child_frame_id','pose','twist','yaw','pitch','roll','type']
  _slot_types = ['std_msgs/Header','string','geometry_msgs/PoseWithCovariance','geometry_msgs/TwistWithCovariance','float64','float64','float64','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,child_frame_id,pose,twist,yaw,pitch,roll,type
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3dB().pack(_x.yaw, _x.pitch, _x.roll, _x.type))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.yaw, _x.pitch, _x.roll, _x.type,) = _get_struct_3dB().unpack(str[start:end])
      return self
