...
class any final
{
  public:
    ...
    /// Return data without type
    const void* data() const noexcept {
        return empty() ? nullptr : this->vtable->data(this->storage);
    }
  ...
  private:   // Storage and Virtual Method Table
    ...
    struct vtable_type
    {
        ...
        const void* (*data)(const storage_union&) noexcept;
    ...
    struct vtable_dynamic
    {
        ...
        static const void* data(const storage_union& storage) noexcept
        {
    ...
    static vtable_type* vtable_for_type()
    {
        ...
        static vtable_type table = {
            VTableType::type, VTableType::data, VTableType::destroy, VTableType::copy,
