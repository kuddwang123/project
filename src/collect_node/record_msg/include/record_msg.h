 ...
 * 
 */
#ifndef SRC_COLLECT_NODE_RECORD_MSG_INCLUDE_RECORD_MSG_H_
#define SRC_COLLECT_NODE_RECORD_MSG_INCLUDE_RECORD_MSG_H_
#include <string>
#include <thread>
...
namespace collect_node_record_msg {  // your namespace
class RecordMsg : public hj_bf::Function {
 public:
  explicit RecordMsg(const rapidjson::Value& json_conf);
  ~RecordMsg();
 private:
  bool initizlize();
  bool CheckDisk();
...
#endif  // SRC_COLLECT_NODE_RECORD_MSG_INCLUDE_RECORD_MSG_H_
