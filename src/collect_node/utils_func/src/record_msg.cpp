...
void RecordMsg::SocImuChatterCallback(const hj_interface::SocImu::ConstPtr &msg) {
  ...
  if (write(fd_soc_imu_, str, strlen(str)) < 0) {
    HJ_ERROR("SocImuChatterCallback Failed to write to file.");
  }
}
...
void RecordMsg::DustPlugCallback(const hj_interface::DustPlugDetection::ConstPtr& msg) {
  ...
  if (write(fd_dust_plug_, str, strlen(str)) < 0) {
    HJ_ERROR("DustPlugCallback Failed to write to file.");
  }
}
#else
...
void RecordMsg::MotorCurCallback(const hj_interface::ElecMotorCur::ConstPtr& msg) {
  ...
  if (write(fd_motor_cur_, str, strlen(str)) < 0) {
    HJ_ERROR("MotorCurCallback Failed to write to file.");
  }
}
...
void RecordMsg::TurbidityCallback(const hj_interface::Turbidity::ConstPtr& msg) {
  ...
  if (write(fd_tur_, str, strlen(str)) < 0) {
    HJ_ERROR("TurbidityCallback Failed to write to file.");
  }
}
...
void RecordMsg::TempHumidityCallback(const hj_interface::TempHumidity::ConstPtr& msg) {
  ...
  if (write(fd_temp_humidity_, str, strlen(str)) < 0) {
    HJ_ERROR("TempHumidityCallback Failed to write to file.");
  }
}
...
void RecordMsg::BatCallback(const hj_interface::Bat::ConstPtr& msg) {
  ...
  if (write(fd_bat_, str, strlen(str)) < 0) {
    HJ_ERROR("BatCallback Failed to write to file.");
  }
}
...
void RecordMsg::PumpMotorSpeedCallback(const hj_interface::PumpMotorSpeed::ConstPtr& msg) {
  ...
  if (write(fd_pump_motor_speed_, str, strlen(str)) < 0) {
    HJ_ERROR("PumpMotorSpeedCallback Failed to write to file.");
  }
}
...
void RecordMsg::FanMotorSpeedCallback(const hj_interface::FanMotorSpeed::ConstPtr& msg) {
  ...
  if (write(fd_fan_motor_speed_, str, strlen(str)) < 0) {
    HJ_ERROR("FanMotorSpeedCallback Failed to write to file.");
  }
}
...
void RecordMsg::OutWaterCallback(const std_msgs::UInt8::ConstPtr& msg) {
  ...
  if (write(fd_out_water_, str, strlen(str)) < 0) {
    HJ_ERROR("OutWaterCallback Failed to write to file.");
  }
}
...
void RecordMsg::createInstance(const recordMsgParam& param) {
  ...
  machine_version_ = param.machine_version;
  record_all_topics_ = param.record_all_topics;
  for (auto &topic : param.topics) {
    topics_.emplace(std::make_pair(topic, true));
  }
